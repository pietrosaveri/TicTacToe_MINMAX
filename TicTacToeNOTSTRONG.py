    ...
    def final_state(self, show = False):
        ...
        for col in range(COLS):
            if self.squares[0][col] == self.squares[1][col] == self.squares[2][col] != 0:
                ...
                return self.squares[0][col] #retunr the palyer who won
...
class AI:
    ...
    def minimax(self, board, maximizing):
        ...
        #platyer 2 wins
        if case == 2:
            return -1, None#miminazing and player 2
        ...
        if maximizing:
            ...
            for (row, col) in empty_sqrs:
                ...
                if eval > max_eval: #for the first time always in
                    max_eval = eval
                    best_move = (row, col)
            ...
            for (row, col) in empty_sqrs:
                ...
                if eval < min_eval: #for the first time always in
                    min_eval = eval
                    best_move = (row, col)
...
class Game:
    ...
    def __init__(self):
        self.board = Board()
        self.ai = AI()
        self.player = 2 #1-cross #2-cirles #1 we start, 2 ai starts
